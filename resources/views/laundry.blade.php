...
<div class="jumbotron-laundry">
    <div class="container">
        <div class="row">
                ...
                <div class="col-md-4">
                    <h2 style="font-weight: bold; color:white; margin-top:300px;">FITUR MANAGEMENT LAUNDRY</h2>
                </div>
        </div>
    </div>
</div>
...
<div class="container">
    <div class="row mt-5 mb-5">
      ...
      <div class="col-md-6 mt-5">
        <h1>Dashboard Data Pendapatan</h1>
  ...
  <div class="row mt-5 mb-5">
    ...
    <div class="col-md-6 mt-5">
      <h1>Management Data Transaksi</h1>
...
<div class="row mt-5 mb-5">
    ...
    <div class="col-md-6 mt-5">
      ...
      <p>Tersedia juga aplikasinya untuk mendapatkan fitur lengkapnya. Download sekarang</p>
      <div class="row">
          <div class="col-md-6">
              <img src="img/playstore.png" style="width:300px;" alt="">
          </div>
          <div class="col-md-6">
            <img src="img/barcode.png" style="width:200px;" alt="">
        </div>
      </div>
    </div>
  </div>
